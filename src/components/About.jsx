        ...
        <section className="text-white body-font py-12 px-5">
          ...
          <div className="flex flex-wrap -m-4 text-center">
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="border-2 border-gray-200 p-6 rounded-lg transform transition duration-300 hover:scale-105">
                <svg fill="none" stroke="currentColor" className="text-indigo-500 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
